                ...
                <ul class="navbar-nav iq-main-menu">
                    <li class="nav-item static-item">
                        <a class="nav-link static-item disabled" href="#" tabindex="-1">
                            <span class="default-icon text-primary">Trang quản trị</span>
                            <span class="mini-icon">-</span>
                        </a>
                    </li>  
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="{{URL::to('dashboard')}}">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @hasrole(['admin', 'owner','moderator'])
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-category" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                            
                            ...
                            <span class="item-name">Danh mục sản phẩm</span>
                            <i class="right-icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-category" data-bs-parent="#sidebar">
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('all-category-product')}}">
                                    ...
                                    <span class="item-name">Liệt kê danh mục</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-product" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                        ...
                        <ul class="sub-nav collapse" id="sidebar-product" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('add-product')}}">
                                    ...
                                    <span class="item-name">Thêm sản phẩm</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('all-product')}}">
                                    ...
                                    <span class="item-name">Liệt kê sản phẩm</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('import-product')}}">
                                    <i class="icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                            <g>
                                                <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                    ...
                                    <span class="item-name">Import sản phẩm</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-post" role="button" aria-expanded="false" aria-controls="sidebar-user">
                            <i class="icon">
                            ...
                            <span class="item-name">Bài Viết</span>
                            <i class="right-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                                </svg>                                
                        ...
                        <ul class="sub-nav collapse" id="sidebar-post" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('add-post')}}">
                                    ...
                                    <span class="item-name">Thêm bài viết</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('all-post')}}">
                                    ...
                                    <span class="item-name">Liệt kê bài viết</span>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="{{ URL::to('manage-review')}}" target="_blank">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.1043 4.17701L14.9317 7.82776C15.1108 8.18616 15.4565 8.43467 15.8573 8.49218L19.9453 9.08062C20.9554 9.22644 21.3573 10.4505 20.6263 11.1519L17.6702 13.9924C17.3797 14.2718 17.2474 14.6733 17.3162 15.0676L18.0138 19.0778C18.1856 20.0698 17.1298 20.8267 16.227 20.3574L12.5732 18.4627C12.215 18.2768 11.786 18.2768 11.4268 18.4627L7.773 20.3574C6.87023 20.8267 5.81439 20.0698 5.98724 19.0778L6.68385 15.0676C6.75257 14.6733 6.62033 14.2718 6.32982 13.9924L3.37368 11.1519C2.64272 10.4505 3.04464 9.22644 4.05466 9.08062L8.14265 8.49218C8.54354 8.43467 8.89028 8.18616 9.06937 7.82776L10.8957 4.17701C11.3477 3.27433 12.6523 3.27433 13.1043 4.17701Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>                                        </svg>                                    
                            </i>
                        ...
                        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('add-user')}}">
                                    ...
                                    <span class="item-name">Thêm người dùng</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{{ URL::to('all-user')}}">
                                    ...
                                    <span class="item-name">Liệt kê người dùng</span>
                                </a>
                            </li>
                        ...
                        <ul class="align-items-center navbar-nav ms-auto navbar-list mb-2 mb-lg-0">
                                        ...
                                        <div class="card-body p-0">
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset('backendbackend/assets/images/shapes/01.png')}}" alt="">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <div class="">
                                                        <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset('backendbackend/assets/images/shapes/02.png')}}" alt="">
                                                    </div>
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset('backendbackend/assets/images/shapes/03.png')}}" alt="">
                                                    <div class="ms-3 w-100">
                                            ...
                                            <a href="#" class="iq-sub-card">
                                                <div class="d-flex align-items-center">
                                                    <img class="avatar-40 rounded-pill bg-soft-primary p-1" src="{{ asset('backendbackend/assets/images/shapes/04.png')}}" alt="">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link py-0 d-flex align-items-center" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="{{ asset('backend/assets/images/avatars/01.png')}}" alt="User-Profile" class="img-fluid avatar avatar-40 avatar-rounded">
...
@yield('admin_content')
    ...
    <script>
         ...
         CKEDITOR.replace('exampleFormControlTextarea1ck1');
         CKEDITOR.replace('exampleFormControlTextarea2ck2');
         CKEDITOR.replace('exampleFormControlTextarea1ck3');
         CKEDITOR.replace('exampleFormControlTextarea2ck4');
